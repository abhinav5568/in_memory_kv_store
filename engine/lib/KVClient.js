...
class KVClient {
     ...
     * @param {string} options.userId - uuid string assigned via INIT
     * @param {string} [options.host = '127.0.0.1'] - Database host
     * @param {number} [options.port = 6379] - Database port
     */
    constructor(options = {}) {
        this.userId = options.userId; // Standardized to camelCase userId
        ...
        // Track connection promises reliably
    ...
    connect() {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.client.on("data", (chunk) => {
                ...
                let i;
                // FIXED: Corrected parentheses alignment to prevent infinite loops
    ...
    _handleServerResponse(frame) {
        // Handle Handshake responses safely using class instance references
